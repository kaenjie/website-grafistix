        ...
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between px-6 lg:px-16">
          ...
          <center>
            <div className="lg:w-[58%] lg:mt-0">
              ...
              <p
                className={`font-sans text-slate-400 text-[14px] md:text-[20px] lg:text-1 mb-8 leading-relaxed text-justify transition-opacity duration-1000 ease-out transform ${
                  textVisible ? 'opacity-50 translate-y-0' : 'opacity-0 translate-y-5'
                }`}
              >
              ...
              <div className="flex justify-center gap-4">
                <a
                  ...
                  className={`font-sans bg-[#17A9E8] text-[#0D255E] px-6 py-3 font-bold rounded-lg hover:text-white transition-all duration-500 ease-in-out hover:bg-gradient-to-r from-blue-500 to-indigo-500 shadow-lg hover:scale-105 hover:text-black transition transform ${
                    textVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
                  }`}
                >
                  Konsultasi Gratis
