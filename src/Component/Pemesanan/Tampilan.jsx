...
const Tampilan = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#7ABAFF] via-[#6699FF] to-[#7ABAFF] rounded-lg blur-lg opacity-20 transform scale-110"></div>
      <a 
      href = "/form" 
      className="relative px-20 py-8 bg-gradient-to-r from-[#7ABAFF] via-[#6699FF] to-[#7ABAFF] text-white font-semibold rounded-lg shadow-lg hover:shadow-xl hover:from-[#6699FF] hover:via-[#7ABAFF] hover:to-[#6699FF] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transform transition-transform duration-300 hover:scale-105">
        PESAN SEKARANG!
      </a>
      </div>
      ...
      {/* FAQ */}
      <div className="bg-indigo-950 rounded-xl text-white mt-16 mx-6 mb-4 md:mx-10 md:-mb-8 md:mt-18 py-10 px-4 md:px-8 xl:mx-14 xl:px-12">
