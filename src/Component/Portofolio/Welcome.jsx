  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <p
          className={`text-lg lg:text-xl mb-5 lg:mb-8 text-white transition-all duration-1000 ease-out transform delay-200 ${
            isVisible ? "opacity-80 translate-y-0 floating" : "opacity-0 -translate-y-10"
          }`}
        >
